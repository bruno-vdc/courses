...
def load_model():
    ...
    """
    print('reading model...')
    os.environ['MLFLOW_TRACKING_USERNAME'] = 'bruno-vdc'
    os.environ['MLFLOW_TRACKING_PASSWORD'] = 'bd9249ee9c5c5727095a077f52a9f7bac9a55ca9' # VALIDEM SE O TOKEN ESTÁ ATIVO, SE NÃO ESTIVER CRIE O SEU PRÓPRIO REPOSITÓRIO E SEU TOKEN
    mlflow.set_tracking_uri('https://dagshub.com/bruno-vdc/mlops-puc.mlflow') # EXEMPLO: https://dagshub.com/myuser/myrepo.mlflow'
